...
The preferred way to configure an input select is via the user interface at **Configuration** -> **Automations & Scenes** -> **Helpers**. Click the add button and then choose the **Dropdown** option.
